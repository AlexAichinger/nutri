...
class MealEntryService(
    ...
    private fun manualLogging(entry: ManualMealEntryDto): MealEntry {
    ...
    private fun automaticLogging(entry: AutomaticTrackingMeal): MealEntry {
...
fun ClientProductInfo.toMealEntry(user: String, mealType: MealType, entryDate: LocalDate, eatenInGrams: BigDecimal): MealEntry {
    ...
    return MealEntry(
        ...
        foodInformation = FoodInformation(
            ...
            macroNutrients = MacroNutrients(
                ...
                fruitsVegetablesLegumesEstimateFromIngredientsServing = nutrients.macros.fruitsVegetablesNutsEstimateFromIngredients100g.multiply(
                    ratio
                ),
                fruitsVegetablesNutsEstimateFromIngredients100g = nutrients.macros.fruitsVegetablesNutsEstimateFromIngredients100g,
                fruitsVegetablesNutsEstimateFromIngredientsServing = nutrients.macros.fruitsVegetablesNutsEstimateFromIngredients100g.multiply(ratio),
